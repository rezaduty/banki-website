...
project = u'نوبت دهی غیر حضوری بانک Banki'
copyright = u'2018, The Banki Team'
...
htmlhelp_basename = 'Testdocs'

html_context = {
    'display_github': False,
    'github_user': 'rezaduty',
    'github_repo': 'docs',
...
texinfo_documents = [
  ('index', 'Syncthing', u'Js Learning Documentation',
   u'The Js Authors', 'Js', 'One line description of project.',
   'Miscellaneous'),
]
